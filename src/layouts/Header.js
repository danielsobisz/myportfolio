    ...
    <header className="header flex-container">
      ...
      <div className="contact-items">
        <div className="contact-item">
          <a href="https://github.com/danielsobisz">
            <SVGIcon name="github" width={75} />
          </a>{" "}
        </div>
        <div className="contact-item">
          <a href="https://www.linkedin.com/in/daniel-sobisz-552a26179/">
            <SVGIcon name="linkedin" width={75} />
          </a>
        </div>
        <div className="contact-item">
          <a href="mailto: dsobisz97@gmail.com">
            <SVGIcon name="email" width={75} />
          </a>
        </div>
      </div>
